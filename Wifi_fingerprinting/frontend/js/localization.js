...
class LocalizationManager {
    ...
    *   6c:31:0e:56:e1:XX  →  B-wing labs (Design/AID)     (x≈18, y≈13)
    *   40:01:7a:53:96:XX  →  B-wing labs (CI/DCL)         (x≈32, y≈13)
    *   f8:0b:cb:f3:88:XX  →  A-wing labs (MIDAS)          (x≈84, y≈13)
    *   40:01:7a:53:97:XX  →  A-wing labs (IRAS/HMI)       (x≈104, y≈13)
    *   30:8b:b2:61:de:XX  →  Lift / Open Area             (x≈62, y≈8)
     */
    getSimulatedWifiReadings(x, y) {
        const apGroups = [
            // [bssid_base, ap_x, ap_y, suffix_list]
            ['6c:31:0e:56:e1', 18, 13, ['20','21','22','23','24','25']],
            ['40:01:7a:53:96', 32, 13, ['80','81','82','83','84','8a','8f']],
            ['f8:0b:cb:f3:88', 84, 13, ['00','01','04','05','0b','0e']],
            ['40:01:7a:53:97', 104, 13, ['20','21','22','23']],
            ['30:8b:b2:61:de', 62, 8, ['00','01','02','03','05','0a','0b','0e','0f']]
        ];
