...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (mapCanvas) {
        mapCanvas.addEventListener('mapClick', function (e) {
            var detail = e.detail;
            if (detail.x >= 0 && detail.x <= 65 && detail.y >= 0 && detail.y <= 22) {
    ...
    async function init() {
        ...
        locManager.setManualPosition(54.0, 5.0);
        console.log('[APP] Initial position set to Lift Area (54, 5)');
        ...
        floorMap.setUserPosition(54.0, 5.0);
